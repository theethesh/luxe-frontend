        ...
        <div className="bg-[#12121A] border border-white/5 rounded-3xl p-12 text-center max-w-md">
          <div className="relative inline-block mb-8">
            ...
            <div className="relative w-32 h-32 mx-auto bg-[#8B5CF6]/5 rounded-full flex items-center justify-center border border-[#8B5CF6]/10">
              <ShoppingBag className="w-16 h-16 text-[#8B5CF6] opacity-30" />
            </div>
          </div>
          <h2 className="text-3xl font-light text-white tracking-tight">
            No Order <span className="text-[#8B5CF6] font-medium">Found</span>
          </h2>
          <p className="text-white/20 text-sm font-light mt-3">You haven't placed any orders yet.</p>
          <button
            onClick={() => router.push("/")}
            className="mt-8 bg-gradient-to-r from-[#8B5CF6] to-[#A855F7] text-white px-10 py-4 rounded-full font-light tracking-wider hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_0_40px_rgba(139,92,246,0.1)] flex items-center gap-2 mx-auto border border-white/5"
          >
